...
const initialProjects = [
  { id: 'guru', name: '股流Radar', description: '兩段式產品：雷達（熱度四成分公式：資金35%／價格25%／量異常20%／廣度20% → 熱區分層聚焦/升溫/分歧/退潮）+ g研判（PA Facts Layer純函式計算結構/關鍵位/形態，Coach Engine六段框架輸出條件式情境）。三約束：資料可替換、事實先於AI、單向依賴。Phase1唯一策略pa_default，Phase2上v2四戰法（回湧/破堤/鯨躍/洋流）', stage: 'Active', color: '#e76f51', progress: 58, lastUpdated: Date.now(), next: '把架構規格寫進產品' },
...
const initialNotes = [
  ...
  { id: 'note-3', title: 'SUNO 聽了二十首參考曲', content: '決定走深夜氛圍，人聲少一點，留空間給低頻。先鎖這個方向。', tags: ['靈感', '音樂'], projectId: '', createdAt: Date.now() - 7 * DAY },
